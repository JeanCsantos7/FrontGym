  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col items-center">
      <div className="w-full px-4 sm:px-6 lg:px-8 py-10">
        <Header />
        <h1 className="text-3xl text-center font-bold text-[#e26631] mb-2">Meu Treino</h1>
            ...
            result.map((item) => (
              ...
              >
                ...
                <div className="p-5 space-y-3">
                  <h3 className="text-xl font-semibold text-[#e26631]">{item.nome_exercicio}</h3>
                  ...
                  >
                    ...
                    <label className="block font-semibold text-[#e26631]">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          handleInputChange(item.id, "repeticoes", e.target.value)
                        }
                        required
                        className="mt-1 w-full px-4 py-2 border border-[#e26631] rounded-md outline-none focus:ring-2 focus:ring-[#e26631]/40"
                      />
